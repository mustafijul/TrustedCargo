...
export default function SendParcel() {
  ...
  const calculatePrice = () => {
    ...
    if (parcelType === "document") {
      ...
      if (weight <= 3) {
        ...
        price = isWithinCity
          ? 110 + additionalCharge
          : 150 + additionalCharge + 40;
      }
    }
    return price;
  };
  ...
  const onSubmit = (data) => {
    ...
    if (!data.parcelType) {
      Swal.fire("Error", "Please select parcel type!", "error");
      return;
    }
    ...
    if (!data.senderRegion || !data.receiverRegion) {
      Swal.fire(
        "Error",
        "Please select both sender and receiver regions!",
        "error"
      );
      return;
    }
